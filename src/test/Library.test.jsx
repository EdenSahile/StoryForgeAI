...
describe('Library — suppression d\'une entrée individuelle', () => {
  ...
  it('vue liste : DeleteBtn + confirm() true supprime l\'entrée, storage mis à jour, reste en vue liste (stopPropagation)', () => {
  ...
  it('vue liste : DeleteBtn + confirm() false ne supprime rien', () => {
    const a = saveGeneration({ brief: 'A', stories: 'SA', sourcesUsed: [], storiesCount: 1 });
    vi.spyOn(window, 'confirm').mockReturnValue(false);
    render(<Library />);
  ...
  it('vue détail : le bouton "Supprimer" supprime l\'entrée et ramène automatiquement à la vue liste', () => {
    const a = saveGeneration({ brief: 'A', stories: 'SA', sourcesUsed: [], storiesCount: 1 });
    vi.spyOn(window, 'confirm').mockReturnValue(true);
    render(<Library />);
